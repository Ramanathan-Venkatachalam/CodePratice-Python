...
direction = input('You\'re at a main-road. Where do you want to go? Type left or right: ').lower()
if direction == "left":
  stay = input('You\'ve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim across.: ').lower()
  if stay == "wait":
    ...
    print(f"You are attacked by the crocodiles, GAME OVER")  
else:
  print(f"Fall into a drainage. GAME OVER")